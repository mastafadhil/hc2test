...
## Run "pytest test_tenant_basic.py --var1='pateh59707@fesgrid.com' --var2='@Bcd1234' --dashboard --html=report_test-server_tenantbasic.html --reruns=3"
...
class TransactionHistory(BaseCase):
    ...
    download_history_2 = ("(//tbody/tr[1]/td[3]/a[1]//*[name()='svg']")
